...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Courier+New&size=20&duration=3000&pause=500&color=4169E1&background=000000FF&center=true&vCenter=true&width=700&lines=%3E_+Talking+directly+to+the+silicon...;%3E_+Bare-metal+C%2FC%2B%2B+for+ARM%2C+AVR%2C;%3E_+Custom+FPGA+%26+PCB+Design;%3E_%26Real-Time+Systems;%3E_+IoT%2FOTA+%26+Security+Architecture)](https://github.com/0xNaviMetal)
...
My world:  
-  Bare-metal C/C++ for ARM, AVR
-  Custom FPGA & PCB design (analog/digital, SMPS, timing)
-  bootloaders, board bring-up
-  IoT/OTA, OSI stack
-  DSP, sensors, signals
